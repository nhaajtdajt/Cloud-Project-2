...
\subsection{Chi tiết các câu Prompt nổi bật}
...
\textbf{Câu Prompt:} \textit{"bạn đọc thật kĩ file đồ án 2 de.md này của tôi đi đọc thật kĩ để hiểu và tôi sẽ đưa ra yêu cầu cho bạn làm... đọc kĩ lại 1 lần để không sót bất cứ 1 chức năng hay ý nào đi"}\\
\textbf{Kết quả:} AI đã đọc và tổng hợp thành bảng phân tích chi tiết gồm 7 thành phần chính, 16 mục bằng chứng, rubric chấm điểm và 8 điểm cấm.\\
\textbf{Đánh giá:} AI đã làm tốt phần này.

\subsubsection{Prompt \#2 — Phân công công việc cho 3 thành viên}
\textbf{Ngày:} 25/05/2026 $|$ \textbf{Model:} Claude Opus\\
\textbf{Câu Prompt:} \textit{"giờ tôi sẽ làm đồ án này với 3 người bạn hãy suy nghĩ thật kĩ để tạo công việc ra cho 3 người và chỉ rõ ra từng bước..."}\\
\textbf{Kết quả:} AI tạo bản kế hoạch phân công cực kỳ chi tiết gồm 31+ bước, chia cho 3 người, kèm sơ đồ triển khai và bảng phối hợp.\\
\textbf{Đánh giá:} Tốt.

\subsubsection{Prompt \#3 — Viết toàn bộ source code Frontend + Backend}
\textbf{Ngày:} 25/05/2026 $|$ \textbf{Model:} Claude Opus + Gemini Pro\\
\textbf{Kết quả:} AI tạo toàn bộ cấu trúc dự án và viết code cho 11 files (6 frontend, 4 backend Lambda). Đầy đủ chức năng CRUD, CORS, validation.\\
\textbf{Đánh giá:} Tốt.

\subsubsection{Prompt \#4 — Hướng dẫn cấu hình AWS Budget}
\textbf{Ngày:} 03/06/2026 $|$ \textbf{Model:} Gemini Pro\\
\textbf{Câu Prompt:} \textit{"tôi đang làm tới đây có đúng không và làm gì nữa" (kèm ảnh)}\\
\textbf{Kết quả:} AI nhận ra lỗi dùng sai template "Zero spend budget" (chỉ có 1 mức cảnh báo) và hướng dẫn cấu hình chi tiết 2 mức 80\% và 100\% để không bị trừ điểm.\\
\textbf{Đánh giá:} AI đã hướng dẫn đúng phần này.

\subsubsection{Prompt \#5 — Viết 3 file báo cáo chi tiết}
\textbf{Ngày:} 03/06/2026 $|$ \textbf{Model:} Claude Opus\\
\textbf{Câu Prompt:} Yêu cầu sinh ra 3 file báo cáo đầy đủ, chi tiết, hướng dẫn người dùng chụp ảnh minh chứng.\\
\textbf{Kết quả:} Tạo ra 3 file Markdown chi tiết cho 3 người (Frontend, Backend, Infra) với chú thích chụp ảnh rõ ràng.\\
...
\textbf{Câu Prompt:} \textit{"cho tôi code vẽ bằng mermaid để vẽ cái này đi vẽ chi tiết cho tôi nhé"}\\
\textbf{Kết quả:} Sinh ra code Mermaid so sánh 2 luồng đi với giải thích chi phí (\$0.045/giờ vs \$0).\\
\textbf{Đánh giá:} Tốt.

\subsubsection{Prompt \#7 — Vẽ sơ đồ kiến trúc tổng thể}
\textbf{Ngày:} 06/06/2026 $|$ \textbf{Model:} Claude Sonnet\\
\textbf{Câu Prompt:} \textit{"Giờ vẽ cho tôi phần này nhé thật chi tiết vào vì đây là phần quan trọng cho tôi code ở dạng mermaid và không để icon vào"}\\
\textbf{Kết quả:} Sinh ra code Mermaid đầy đủ 9 tầng kiến trúc, mã màu rõ ràng, ghi chú chi tiết.\\
\textbf{Đánh giá:} Đã kiểm tra và thấy hợp lý.

\subsubsection{Prompt \#8 — Giải thích cách tắt Client Secret trong Cognito}
\textbf{Ngày:} 28/05/2026 $|$ \textbf{Model:} Gemini 3.1 Pro\\
\textbf{Câu Prompt:} Hỏi về việc Cognito tự sinh Client Secret và cách tắt nó khi tạo App Client cho Frontend.\\
\textbf{Kết quả:} AI phát hiện vi phạm bảo mật (Frontend không được dùng Client Secret) và hướng dẫn cách tạo lại App Client với tùy chọn "Don't generate a client secret".\\
\textbf{Đánh giá:} Khắc phục tốt vấn đề bảo mật.
