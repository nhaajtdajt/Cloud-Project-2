...
const USER_1 = "593a35ec-c0c1-702d-48b1-5b81fbc6fe4c";
const USER_2 = "69ea855c-4091-707d-8e44-2da007a38e35";
...
async function seed() {
  ...
  console.log(
    "Lưu ý: Bạn cần tạo 2 user trong Cognito và cập nhật userId trong script này để map đúng.",
  );
}
